...
<div class="flex flex-col gap-4">
    ...
    <p>
        ...
        <br><br>
        I've also used C++ for several short scripts that were required to run very efficiently, such as searching through masses
        amount of data on the file system to search for data, which I used for my <a href="https://github.com/edqx/diabotical-crawler">Diabotical account crawler</a>.
    </p>
</div>